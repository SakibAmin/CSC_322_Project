...
def browse_all_complains(USER_ID):
    def view_complain(data):
        ...
        def appealComplain():
            ...
            def return_reason():
                def appeal_to_database(text):
                    ...
                    sql_query = "SELECT name FROM computer_store.store_clerk WHERE clerk_id=" + str(USER_ID)
                    cursor.execute(sql_query)
        ...
        sql_query = "SELECT * FROM computer_store.store_clerk WHERE clerk_id=" + str(data[2])
        cursor.execute(sql_query)
    ...
    sql_query = "SELECT * FROM computer_store.store_clerk WHERE clerk_id=" + str(USER_ID)
    cursor.execute(sql_query)
